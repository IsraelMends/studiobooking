...
export default function Login(){
  ...
  return (
    <View style={{ flex:1, backgroundColor: '#0b0f13', padding: 20, justifyContent: 'center', gap: 12 }}>
      ...
      {isRegister && (
        <TextInput placeholder='Nome' placeholderTextColor='#9aa0a6' style={styles.input}
          value={form.name} onChangeText={t=> setForm({...form, name:t})} />
      )}
      <TextInput placeholder='E-mail' placeholderTextColor='#9aa0a6' style={styles.input}
        value={form.email} onChangeText={t=> setForm({...form, email:t})}
        autoCapitalize='none' keyboardType='email-address' />
      <TextInput placeholder='Senha' placeholderTextColor='#9aa0a6' style={styles.input}
        secureTextEntry value={form.password} onChangeText={t=> setForm({...form, password:t})} />
      {isRegister && (
        <>
      ...
      <Pressable onPress={onSubmit} disabled={busy}
        style={{ backgroundColor:'#20232a', padding:12, borderRadius:12, opacity: busy ? 0.7 : 1 }}>
